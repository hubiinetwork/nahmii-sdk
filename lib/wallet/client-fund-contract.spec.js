...
const CONTRACT_NAME = 'ClientFund';
const CONTRACT_FILE = 'client-fund-contract';
...
function createContract(walletOrProvider) {
    const ClientFundContract = proxyquire('./' + CONTRACT_FILE, {
    ...
    return new ClientFundContract(walletOrProvider);
}
