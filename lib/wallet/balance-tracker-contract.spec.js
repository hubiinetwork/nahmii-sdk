...
const CONTRACT_NAME = 'BalanceTracker';
const CONTRACT_FILE = 'balance-tracker-contract';
...
function createContract(walletOrProvider) {
    const BalanceTrackerContract = proxyquire('./' + CONTRACT_FILE, {
    ...
    return new BalanceTrackerContract(walletOrProvider);
}
