...
describe('Receipt', () => {
    ...
    const hashPaymentAsOperator = payment => {
        ...
        let feesTotalHash = 0;
        for (let i = 0; i < payment.sender.fees.total.length; i++) {
            feesTotalHash = hash(
                feesTotalHash,
                payment.sender.fees.total[i].originId,
                payment.sender.fees.total[i].figure.amount,
                payment.sender.fees.total[i].figure.currency.ct,
                payment.sender.fees.total[i].figure.currency.id
            );
        }
        ...
        signedPayload = {
            ...
            seals: {
                ...
                operator: {
                    ...
                    signature: {
                        r: '0x93e11f9daf499a8731b7c80f1d83bd3d851f0fd07e508800f94040f2469cfcf8',
                        s: '0x7083d501ed97c2424a7ad8486755fa3aabb46ca0fd09bc2cc502489e74159ce5',
                        v: 28
                    }
                }
            }
