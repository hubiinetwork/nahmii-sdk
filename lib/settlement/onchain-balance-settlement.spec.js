...
describe('OnchainBalanceSettlement', () => {
    ...
    context('initiate from constructor', () => {
        ...
        it('should return an instance with no states sync from contracts', () => {
            const onchainBalanceSettlement = new OnchainBalanceSettlement(stubbedWallet.address, currency.ct, ethers.utils.bigNumberify(1), stubbedProvider);
                ...
                beforeEach(() => {
                    ...
                    stubbedNullSettlementChallengeContract
                        ...
                        .withArgs([
                            ...
                            onchainBalanceSettlement.currency,
                            0
                        ])
                        .returns(data);
                    stubbedWallet
