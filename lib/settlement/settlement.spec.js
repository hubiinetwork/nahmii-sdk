...
describe('Settlement', () => {
    ...
    describe('#startChallenge', () => {
        ...
        it('should not start any challenges when the stage amount is greater than the nahmii balance', () => {
            
        });

        it('should not start driip settlement when there is an ongoing null settlement', () => {
