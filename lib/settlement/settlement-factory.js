...
class SettlementFactory {
     ...
     * @param {EthereumAddress|string} address - The ethereum address
     * @param {MonetaryAmount} stageMonetaryAmount - The intended stage amount in a currency
    ...
    async calculateRequiredSettlements(address, stageMonetaryAmount) {
        try {
            ...
            throw new Error('Unable to prepare settlements to cover the full intended stage amount.');
        }
        catch (error) {
            throw new NestedError(error, 'Unable to calculate required settlements.');
        }
    }
     ...
     * @param {EthereumAddress|string} address - The ethereum address
     * @param {EthereumAddress|string} ct - The currency address
