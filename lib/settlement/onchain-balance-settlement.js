...
class OnchainBalanceSettlement extends SettlementBase {
    ...
    static async load(address, ct, provider) {
        ...
        const currentSettlement = new OnchainBalanceSettlement(address, ct, stageAmount, provider);
    ...
    static async create(address, ct, stageAmount, provider) {
        ...
        const newSettlement = new OnchainBalanceSettlement(address, ct, stageAmount, provider);
