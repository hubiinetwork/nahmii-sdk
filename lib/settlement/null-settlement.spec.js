...
const stubbedNullSettlementStateContract = {
    maxNonceByWalletAndCurrency: sinon.stub()
};
...
function proxyquireSettlementChallenge() {
    return proxyquire('./null-settlement', {
        ...
        './null-settlement-state-contract': function() {
            return stubbedNullSettlementStateContract;
        },
...
describe('Null settlement operations', () => {
    ...
    afterEach(() => {
        ...
        stubbedNullSettlementStateContract.maxNonceByWalletAndCurrency.reset();
    });
    ...
    describe('#settleNull', () => {
        ...
        it('can not replay a null settlement', (done) => {
            ...
            sinon.stub(nullSettlement, 'getMaxNullNonce').resolves(maxNonce);
            stubbedNullSettlementContract.settleNull
                .withArgs(wallet.address, currency, 0, {})
                .resolves(fakeTx);
            nullSettlement.settleNull(currency, 0).catch(err => {
    ...
    describe('#getMaxNullNonce', () => {
        it('can get max null nonce', async () => {
            ...
            stubbedNullSettlementStateContract.maxNonceByWalletAndCurrency
    ...
    describe('#checkSettleNull', () => {
        ...
        it('should be valid to start new challenge', async () => {
            ...
            stubbedNullSettlementStateContract.maxNonceByWalletAndCurrency
                .withArgs(wallet.address, {ct: currency.ct, id: currency.id})
