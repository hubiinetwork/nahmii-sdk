...
const {hashObject, sign} = require('./utils');
...
class Payment {
     ...
     */
    sign(privateKey) {
        const h = hashObject(this.toJSON(), Payment.getHashProperties());
    ...
    /**
     * Returns the property names which payment hashes are calculated
