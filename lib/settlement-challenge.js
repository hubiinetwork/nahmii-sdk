...
class SettlementChallenge {
     ...
     * @example
     * let nonce = await settlementChallenge.getCurrentPaymentChallengeNonce(address, ct, id);
     */
     ...
     * @example
     * let expirationTime = await settlementChallenge.getCurrentPaymentChallengeExpirationTime(address, ct, id);
     */
     ...
     * @example
     * let hasExpired = await settlementChallenge.hasPaymentChallengeProposalExpired(address, ct, id);
     */
     ...
     * @example
     * let stagedAmount = await settlementChallenge.getCurrentPaymentChallengeStageAmount(address, ct, id);
     */
     ...
     * @example
     * let status = await settlementChallenge.getCurrentPaymentChallengeStatus(address, ct, id);
     */
