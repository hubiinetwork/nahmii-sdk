...
const SettlementChallenge = require('./settlement-challenge');

const _clientFund = new WeakMap();
const _settlementChallenge = new WeakMap();
...
class Wallet extends ethers.Wallet {
    ...
    constructor(privateKey, provider) {
        ...
        _settlementChallenge.set(this, new SettlementChallenge(this));
    }
