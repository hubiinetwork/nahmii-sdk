...
class Wallet extends ethers.Signer {
    ...
    constructor(signer, provider) {
        ...
        if (typeof signer === 'string') 
            this.initializeFromPrivateKey(signer);
        else 
            this.initializeFromCustomParams(signer.signMessage, signer.signTransaction, signer.address);
     ...
     */
    initializeFromCustomParams(signMessage, signTransaction, address) {
        if 
        (
