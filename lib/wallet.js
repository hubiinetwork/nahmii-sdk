...
class Wallet extends ethers.Signer {
    ...
    constructor(signer, provider) {
        ...
        // console.log(this.initializeFromCustomParams(...signer));
        if (typeof signer === 'string') 
            this._initializeFromPrivateKey(signer);
        else 
            this._initializeFromCustomParams(signer.signMessage, signer.signTransaction, signer.address);
    ...
    /**
      ...
      */
    getAddress() {
        return ethers.Wallet.prototype.getAddress.bind(this)();
    }
    ...
    /**
      ...
      */
    getBalance(blockTag) {
        return ethers.Wallet.prototype.getBalance.bind(this)(blockTag);
    }
    ...
    getTransactionCount(blockTag) {
        return ethers.Wallet.prototype.getTransactionCount.bind(this)(blockTag);
    }
    ...
    sendTransaction(transaction) {
        return ethers.Wallet.prototype.sendTransaction.bind(this)(transaction);
    }
     ...
     */
    _initializeFromPrivateKey(privateKey) {
        ...
        this.sign = ethersWallet.sign.bind(this);
    }
     ...
     */
    _initializeFromCustomParams(signMessage, signTransaction, address) {
        if 
        (
