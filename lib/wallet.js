...
class Wallet extends ethers.Wallet {
    ...
    constructor(privateKey, provider) {
        ...
        _driipSettlementContract.set(this, new DriipSettlementContract(this));
    }
    ...
    async depositedBalance() {
        const clientFund = _clientFund.get(this);
        return await clientFund.depositedBalance(this.address, '0x0000000000000000000000000000000000000000', '0');
    }
    ...
    async getCurrentPaymentChallenge() {
        const challengeContract = _driipSettlementChallengeContract.get(this);
        return await challengeContract.walletProposalMap(this.address);
    }
    ...
    async getCurrentPaymentChallengePhase() {
        ...
        const challengeContract = _driipSettlementChallengeContract.get(this);
        const phaseIndex = await challengeContract.challengePhase(this.address);
    ...
    async getCurrentPaymentChallengeStatus() {
        ...
        const challengeContract = _driipSettlementChallengeContract.get(this);
        const statusIndex = await challengeContract.proposalStatus(this.address);
