...
describe('Driip settlement operations', () => {
    ...
    beforeEach(() => {
        ...
        driipSettlement = new DriipSettlement(wallet, address0, address0id);
    });
    ...
    it('can settle payment driip', async () => {
        ...
        let tx = await driipSettlement.settleDriipAsPayment(receipt);
        expect(tx).to.equal(fakeTx);
    });
    ...
    describe('#getCurrentProposalStatus', () => {
        ...
        challengeStatuses.forEach((t, i) => {
            it(`can correctly parse proposal status ${t}`, async () => {
                stubbedDriipSettlementChallengeContract.proposalStatus
                    ...
                    .resolves(i);
                const status = await driipSettlement.getCurrentProposalStatus();
        ...
        it('should rethrow unexpected exception', () => {
            ...
            stubbedDriipSettlementChallengeContract.proposalStatus
                .withArgs(wallet.address, address0, address0id)
                .throws(error);
            return driipSettlement.getCurrentProposalStatus().catch(e => {
    ...
    describe('#getCurrentProposalNonce', () => {
        it('can correctly return nonce', async () => {
            ...
            stubbedDriipSettlementChallengeContract.proposalNonce
                .withArgs(wallet.address, address0, address0id)
                .resolves(nonce);
            const result = await driipSettlement.getCurrentProposalNonce(wallet.address, address0, address0id);
            expect(result).to.equal(nonce);
        });
    ...
    describe('#getCurrentProposalExpirationTime', () => {
        it('can correctly return expiration time', async () => {
            ...
            stubbedDriipSettlementChallengeContract.proposalExpirationTime
                .withArgs(wallet.address, address0, address0id)
                .resolves(timeout);
            const _timeout = await driipSettlement.getCurrentProposalExpirationTime();
        ...
        [
            ...
            it(`should return null when ${error.code} exception thrown`, async () => {
                stubbedDriipSettlementChallengeContract.proposalExpirationTime
                    .withArgs(wallet.address, address0, address0id)
                    .throws(error);
                const time = await driipSettlement.getCurrentProposalExpirationTime();
        ...
        it('should rethrow unexpected exception', (done) => {
            ...
            stubbedDriipSettlementChallengeContract.proposalExpirationTime
                .withArgs(wallet.address, address0, address0id)
                .throws(error);
            driipSettlement.getCurrentProposalExpirationTime().catch(e => {
    ...
    describe('hasProposalExpired', () => {
        it('can correctly return if expired', async () => {
            ...
            stubbedDriipSettlementChallengeContract.hasProposalExpired
                .withArgs(wallet.address, address0, address0id)
                .resolves(hasExpired);
            const _hasExpired = await driipSettlement.hasProposalExpired();
        ...
        [
            ...
            it(`should return null when ${error.code} exception thrown`, async () => {
                stubbedDriipSettlementChallengeContract.hasProposalExpired
                    .withArgs(wallet.address, address0, address0id)
                    .throws(error);
                const expired = await driipSettlement.hasProposalExpired();
        ...
        it('should rethrow unexpected exception', (done) => {
            ...
            stubbedDriipSettlementChallengeContract.hasProposalExpired
                .withArgs(wallet.address, address0, address0id)
                .throws(error);
            driipSettlement.hasProposalExpired().catch(e => {
    ...
    describe('#getCurrentProposalStageAmount', () => {
        it('can correctly return proposal stage amount', async () => {
            ...
            const _stageAmount = await driipSettlement.getCurrentProposalStageAmount();
        ...
        [
            ...
            it(`should return null when ${error.code} exception thrown`, async () => {
                stubbedDriipSettlementChallengeContract.proposalStageAmount
                    .withArgs(wallet.address, address0, address0id)
                    .throws(error);
                const stageAmount = await driipSettlement.getCurrentProposalStageAmount();
        ...
        it('should rethrow unexpected exception', (done) => {
            ...
            stubbedDriipSettlementChallengeContract.proposalStageAmount
                .withArgs(wallet.address, address0, address0id)
                .throws(error);
            driipSettlement.getCurrentProposalStageAmount().catch(e => {
    ...
    describe('#getSettlementHistoryByNonce', () => {
        const nonce = 1;
        it('can get current settlement detailed object', async () => {
            ...
            const details = await driipSettlement.getSettlementHistoryByNonce(nonce);
        ...
        [
            ...
            it(`should return null when ${error.code} exception thrown`, async () => {
                stubbedDriipSettlementContract.settlementByNonce
                    .withArgs(nonce)
                    .throws(error);
                const settlementObj = await driipSettlement.getSettlementHistoryByNonce(nonce);
        ...
        it('should rethrow unexpected exception', (done) => {
            ...
            stubbedDriipSettlementContract.settlementByNonce
                .withArgs(nonce)
                .throws(error);
            driipSettlement.getSettlementHistoryByNonce(nonce).catch(e => {
