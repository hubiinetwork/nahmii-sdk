...
const stubbedDriipSettlementChallengeContract = {
    ...
    walletChallengeMap: sinon.stub(),
    getChallengeStatus: sinon.stub(),
    getPhase: sinon.stub()
};
...
describe('Wallet', () => {
    ...
    afterEach(() => {
        ...
        stubbedDriipSettlementChallengeContract.getChallengeStatus.reset();
        stubbedDriipSettlementChallengeContract.walletChallengeMap.reset();
        stubbedDriipSettlementChallengeContract.getPhase.reset();
        stubbedExchangeContract.settleDriipAsPayment.reset();
        stubbedExchangeContract.settlementByNonce.reset();
    ...
    context('settle payment', () => {
        ...
        it('can start payment challenge period for eth', async () => {
            ...
            stubbedDriipSettlementChallengeContract.startChallengeFromPayment
                .withArgs(receipt.toJSON(), wallet.address, stageAmount.toJSON().amount, {})
                .resolves(fakeTx);
        ...
        it('can not settle payment driip when the settlement is already done before', (done) => {
            ...
            stubbedExchangeContract.settlementByNonce
        ...
        challengePhases.forEach((t, i) => {
            it(`can correctly parse challenge phase ${t}`, async () => {
                stubbedDriipSettlementChallengeContract.getPhase
        ...
        challengeStatuses.forEach((t, i) => {
            it(`can correctly parse challenge status ${t}`, async () => {
                stubbedDriipSettlementChallengeContract.getChallengeStatus
                    .withArgs(wallet.address)
                    .resolves(i);
        ...
        it('can get current challenge detailed object', async () => {
            ...
            stubbedDriipSettlementChallengeContract.walletChallengeMap
                .withArgs(wallet.address)
        ...
        it('can not get current settlement detailed object', async () => {
            ...
            stubbedExchangeContract.settlementByNonce.rejects({});
