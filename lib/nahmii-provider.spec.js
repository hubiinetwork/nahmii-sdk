            ...
            describe('can perform contract balance checks', () => {
                ...
                it('can retrieve the staging balances for an address', async () => {
                    stubbedDriipSettlementChallenge.proposalStageAmount
                        .withArgs(walletAddr, {ct: '0x01', id: ethers.utils.bigNumberify(0)})
                        .resolves(expectedBalances['ABC']);
                    stubbedDriipSettlementChallenge.proposalStageAmount
                        .withArgs(walletAddr, {ct: '0x0000000000000000000000000000000000000000', id: ethers.utils.bigNumberify(0)})
                        .resolves(expectedBalances['ETH']);
