...
class MonetaryAmount {
     ...
     * @param {Integer} id - positive number that identifies the currency item (0 for ERC20 tokens)
     ...
     * @returns {{ct: EthereumAddress}, {id: Integer}} - currency information
     */
    get currency () {
     ...
     * @returns A JSON object that is in the format that nahmii APIs expects
     */
    toJSON() {
        return {
     ...
     * @param {(Object|BigNumber|String|Integer)} - either a JSON object that can be de-serialized to a MonetaryAmount instance, or a currency amount
     * @param {EthereumAddress|String} ct - currency contract address
     * @param {String|Integer} id - positive number that identifies the currency item (0 for ERC20 tokens)
